...
void Get_input(int* inserts_in_main_p) {
   ...
   printf("porcentaje de claves que deben insertarse en los hilos pricipales\n");
   scanf("%d", inserts_in_main_p);
   printf("Cuantas operaciones tatales deben ejecutarse\n");
   scanf("%d", &total_ops);
   printf("Porcentaje de operaciones en buscar (entre 0 y 1)\n");
   scanf("%lf", &search_percent);
   printf("porcentaje de operaciones que deben insertarse (entre 0 y 1)\n");
